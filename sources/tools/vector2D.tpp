...
template< typename T >
Vector2D< T >::Vector2D() : m_array {}, m_size { 0u, 0u }
{}
...
template< typename T >
ImVec2 Vector2D< T >::get_size() const
{
    return m_size;
}

template< typename T >
std::vector< T > const & Vector2D< T >::get_data() const
{
    return m_array;
}

template< typename T >
std::vector< T > Vector2D< T >::operator[] ( unsigned int line ) const
{
...
template< typename T >
std::vector< T > Vector2D< T >::get_row( unsigned int line ) const
{
    return this->operator[] ( line );
}

template< typename T >
T const & Vector2D< T >::get_element( unsigned int column,
                                      unsigned int line ) const
{
    return const_cast< Vector2D< T > * >( this )->get_element( column, line );
}

template< typename T >
T & Vector2D< T >::get_element( unsigned int column, unsigned int line )
{
...
template< typename T >
ImVec2 Vector2D< T >::get_position( unsigned int index ) const
{
    return ImVec2 {
...
template< typename T >
unsigned int Vector2D< T >::get_index( unsigned int column,
                                       unsigned int line ) const
{
...
template< typename T >
unsigned int Vector2D< T >::get_length() const
{
    ASSERTION( check_compat( m_array, m_size ),
               "Size and Array not comptatible" );
...
template< typename T >
void Vector2D< T >::set_size( ImVec2 size, T defaultValue )
{
...
template< typename T >
std::ostream & operator<< ( std::ostream & stream, Vector2D< T > const & array )
{
    return stream << "{ " << array.m_size << " | " << array.m_array << " }";
}

template< typename T >
std::istream & operator>> ( std::istream & stream, Vector2D< T > & array )
{
